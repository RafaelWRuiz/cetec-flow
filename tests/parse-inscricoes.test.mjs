...
test('importa a exportação .xlsx do Vestibulinho', async () => {
  const file = await readFile('C:/Users/rafae/OneDrive/CETEC Vestibulinho/demanda2026_1/demanda_2026-05-03.xlsx')
